...
export const startFullDatabaseSync = mutation({
  args: {
    confirmDangerous: v.literal('I understand this will sync the entire TVDB database'),
  },
  handler: async (ctx, args) => {
    // Safety check
    if (args.confirmDangerous !== 'I understand this will sync the entire TVDB database') {
      throw new Error('Please confirm you understand the implications of this operation');
    }
